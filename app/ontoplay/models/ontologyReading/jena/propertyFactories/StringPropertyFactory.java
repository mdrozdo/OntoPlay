...
//			return false;
    ...
    public OntoProperty createProperty(OntProperty ontProperty, List<OwlElement> domain) {
        return new StringProperty(ontProperty.getNameSpace(), ontProperty.getLocalName(), ontProperty.getRange().getURI(), ontProperty.getLabel(""), domain.toArray(OwlElement[]::new));
    }
