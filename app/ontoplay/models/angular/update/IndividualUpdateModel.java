...
public class IndividualUpdateModel {
	...
	public IndividualUpdateModel(Individual individual, Set<AnnotationProperty> annotationProperties, List<AnnotationAxiom> annotationAxiomsList) {
		if (individual == null) {
	...
	private String getIndividualClass(String individualUri) {
		...
		try {
			return OntologyReader.getGlobalInstance().getIndividual(individualUri).getIndividual().getOntClass(true)
					.getURI();
